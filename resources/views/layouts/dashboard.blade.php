 ...
 <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url ('') }}">Quản lý bán hàng trực tuyến</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li {{ (Request::is('*post-category') ? 'class="active"' : '') }}>
                            <a href="{{ url ('') }}"><i class="fa fa-th-list fa-fw"></i> Thể loại tin tức</a>
                        </li>
                        <li {{ (Request::is('*post') ? 'class="active"' : '') }}>
                            <a href="{{ url ('') }}"><i class="fa fa-newspaper-o fa-fw"></i> Bài biết</a>
                        </li>
                        <li {{ (Request::is('*product-category') ? 'class="active"' : '') }}>
                            <a href="{{ url ('') }}"><i class="fa fa-th-list fa-fw"></i> Loại sản phẩm</a>
                        </li>
                        <li {{ (Request::is('*product') ? 'class="active"' : '') }}>
                            <a href="{{ url ('') }}"><i class="fa fa-tags fa-fw"></i> Sản phẩm</a>
                        </li>
                        <li {{ (Request::is('*cart') ? 'class="active"' : '') }}>
                            <a href="{{ url ('') }}"><i class="fa fa-shopping-cart fa-fw"></i> Giỏ hàng</a>
                        </li>
                        <li {{ (Request::is('*order') ? 'class="active"' : '') }}>
                            <a href="{{ url ('') }}"><i class="fa fa-file-o fa-fw"></i> Hóa đơn</a>
                        </li>
